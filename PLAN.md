...
## Official train 70k 再学習 (2026-06-11 開始)
...
- 学習: yolov8n.pt (COCO) から epochs=10, imgsz=1024, batch=auto, GPU 16GB
  → `runs/official_train/yolov8n_70k_1024`
- 評価プロトコルは従来どおり odd 5,000 macro F1 (`evaluate_bdd100k.py`)。
  学習後に per-kind threshold 再チューニング → TTA/WBF を積む
