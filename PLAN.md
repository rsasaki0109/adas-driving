...
macro F1 = 0.6763, ~3.4 FPS (RTX 4070)
```
...
- [PLAN.md](/media/sasaki/aiueo/ai_coding_ws/adas-perception/PLAN.md)
- [README.md](/media/sasaki/aiueo/ai_coding_ws/adas-perception/README.md)
- [scripts/export_bdd100k_yolo.py](/media/sasaki/aiueo/ai_coding_ws/adas-perception/scripts/export_bdd100k_yolo.py)
- [scripts/analyze_bdd100k_errors.py](/media/sasaki/aiueo/ai_coding_ws/adas-perception/scripts/analyze_bdd100k_errors.py)
- [scripts/visualize_bdd100k_errors.py](/media/sasaki/aiueo/ai_coding_ws/adas-perception/scripts/visualize_bdd100k_errors.py)
- [outputs/bdd100k_yolo_finetuned_all_tuned_split_img1024_kind_tuned_report_odd_5000_grouped_size.json](/media/sasaki/aiueo/ai_coding_ws/adas-perception/outputs/bdd100k_yolo_finetuned_all_tuned_split_img1024_kind_tuned_report_odd_5000_grouped_size.json)
- [outputs/bdd100k_yolo_img1024_kind_tuned_report_odd_5000_errors_all_psl_grouped_analysis.md](/media/sasaki/aiueo/ai_coding_ws/adas-perception/outputs/bdd100k_yolo_img1024_kind_tuned_report_odd_5000_errors_all_psl_grouped_analysis.md)
...
RTX 4070 想定で 10 epoch 全工程は約 3〜4 時間。
...
9. **エッジデプロイ (Jetson Nano / Orin Nano クラス)**:
   ...
   - **要実機**: 開発機 (RTX 4070) では動作確認のみ、FPS 実測は実機で
